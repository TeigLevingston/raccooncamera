...
class Hardware:
    ...
    def pulse_servo_and_relay(self, pause: float) -> None:
        ...
        self.relay.off()
        self.servo.min()
        # small extra sweep to ensure movement is noticeable
        self.servo.max()
    ...
    def startup_exercise(self, frame_to_save: np.ndarray) -> None:
        ...
        for _ in range(STARTUP_TOGGLES):
            self.pulse_servo_and_relay(0.5)
